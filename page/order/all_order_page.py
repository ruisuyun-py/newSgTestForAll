...
def get_floating_sku_info_xpath(row_keywords, sku_info_name):
    ...
    floating_xpath = {
        ...
        "平台商品ID": "/div[@class='cell itemid']/div[@class='sku_id']/div[@class='popup-box']/span[1]/strong",
        "平台规格ID": "/div[@class='cell itemid']/div[@class='sku_id']/div[@class='popup-box']/span[2]/strong",
        "平台货号": "/div[@class='cell itemid']/div[@class='sku_id']/div[@class='popup-box']/span[3]/strong",
        "平台商家编码": "/div[@class='cell itemid']/div[@class='sku_id']/div[@class='popup-box']/span[4]/strong",
        "平台规格名称": "/div[@class='cell itemid']/div[@class='sku_id']/div[@class='popup-box']/span[5]/strong",
        "子单号": "/div[@class='cell itemid']/div[@class='sku_id']/div[@class='popup-box']/span[6]/strong",
        "平台商品名称": "/div[@class='cell itemid']/div[@class='sku_id']/div[@class='popup-box']/strong",
...
def get_floating_platform_sku_info_xpath(row_keywords, sku_info_name):
    """
    sku_info_name:图片,平台商品ID,平台规格ID,平台规格ID,平台货号,平台商家编码,平台规格名称,子单号,平台商品名称,商家编码,
                    货号,其他信息,单价,单价输入框,数量输入框,数量,总价,商品名称,规格名称,库存信息,删除,,,,
    sku_keywords：行关键字，如果为空，返回的是所有行的信息定位，有关键字则是包含关键字的行的信息定位
...
# 获取所有行商品信息文本
def get_all_platform_float_sku_info(sku_info_name):
    all_row_xpath = "//div[@class='table full_item_table']/div"
    all_rows = base.wait_elements(all_row_xpath)
    all_rows_num = len(all_rows)
    result = []
...
def get_all_float_platform_sku_info(sku_info_name):
    all_row_xpath = "//div[@class='table full_item_table']/div"
    all_rows = base.wait_elements(all_row_xpath)
    all_rows_num = len(all_rows)
    result = []
